...
export const SEARCH_RECIPE_INGREDIENT = 'SEARCH_RECIPE_INGREDIENT';
export const SEARCH_RECIPE_AUTHOR = "SEARCH_RECIPE_AUTHOR";
export const PROFILE_UPDATED = 'PROFILE_UPDATED';
export const GET_RECIPE_AUTHOR = 'GET_RECIPE_AUTHOR';
